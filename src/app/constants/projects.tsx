...
export const projectItems: Array<ProjectItem> = [
    {
        ...
        description: "Game development project showcasing my skills in Unity and C#. This project demonstrates my ability to create engaging and interactive gaming experiences, leveraging the power of Unity's game engine and C# programming language.",
        to: "project-item-0",
    ...
    },
    {
        ...
        technology: "Express.js, Node.js, MongoDB, RESTful API, Postman",
        description: "Developed a robust and scalable E-Commerce API using Express.js and Node.js, leveraging MongoDB for efficient data storage and retrieval. Implemented RESTful API endpoints to facilitate seamless communication between the front-end and back-end components of the application. Utilized Postman for comprehensive testing and validation of API functionality, ensuring optimal performance and reliability.",
        to: "project-item-1",
        repository: "https://git.zuitt.co/B620/csp2-B620-calpito-cruzat",
        images: []
    },
    {
        title: "Github Pages Portfolio Website",
        technology: "HTML, CSS, Bootstrap, JavaScript, Github Pages(Deployment)",
        description: "Created a visually appealing and responsive portfolio website using HTML, CSS, and Bootstrap. Implemented interactive features and smooth navigation to enhance user experience. Deployed the website on Github Pages for easy accessibility and sharing.",
        to: "project-item-2",
        repository: "https://github.com/joepris/webportfolio",
        images: []
    },
    {
